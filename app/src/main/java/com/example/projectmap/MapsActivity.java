...
import static com.example.projectmap.AppConfig.*;
...
public class MapsActivity extends AppCompatActivity implements OnMapReadyCallback,
    ...
    private void loadNearByPlaces(double latitude, double longitude) {
        String search = "(shelter) OR (disaster) OR (relief) OR (rescue)";
        StringBuilder googlePlacesUrl =
                new StringBuilder("https://maps.googleapis.com/maps/api/place/nearbysearch/json?");
        googlePlacesUrl.append("keyword=").append(search);
        ...
        try {
            ...
            if (result.getString(STATUS).equalsIgnoreCase(OK)) {
                ...
                for (int i = 0; i < jsonArray.length(); i++) {
                    ...
                    id = place.getString(RESOURCE_ID);
                ...
                Toast.makeText(getBaseContext(), jsonArray.length() + " Resources Found",
                        Toast.LENGTH_LONG).show();
            } else if (result.getString(STATUS).equalsIgnoreCase(ZERO_RESULTS)) {
                Toast.makeText(getBaseContext(), "No Resources found Near You",
                        Toast.LENGTH_LONG).show();
            }
